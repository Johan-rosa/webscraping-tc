...
functions$tasa_dolar_blh()
functions$tasa_dolar_promerica(client)
functions$tasa_dolar_banesco(client)
functions$tasa_dolar_lafise(client)
functions$tasa_dolar_ademi(client)
