...
### Entidades de intermeiación financiera
...
message <- glue(
  ...
  2- Structure:
    ...
    b- ### Entidades de intermediación finciera: three bullets with comments about specific changes in tipo_entidad EIF
    c- ### Agentes de cambio: three bullets with coments about specific changes in tipo_entidad AC 
