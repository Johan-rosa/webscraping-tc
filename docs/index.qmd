...
box::use(
  ...
  reports/logic/ui[summary_cards, trend_indicator],
  scripts/anthropic[
...
# saveRDS(content, here::here("reports/mocked_api_result2.rds"))
...
content <- readRDS(here::here("reports/mocked_api_result2.rds"))
