...
benchmark_lag <- ifelse(day_of_week == "Monday", 3, 1)
...
div(
  ...
  div(
    ...
    div(
      class = "bcrd-label", 
      span(class = "text", glue("Tasas de referencia BCRD / promedio ponderado {tc_spot$fecha}"))
    ),
    div(class = "bcrd-values",
        div(
          class = "bcrd-value", 
          span(class = "bcrd-label", "Compra:"), span(class = "bcrd-amount", round(tc_spot$compra, 2))
        ),
        div(
          class = "bcrd-value", 
          span(class = "bcrd-label", "Venta:"), span(class = "bcrd-amount", round(tc_spot$venta, 2))
        )
    )
  )
)
...
2- Se utilizan promedios simples a lo largo del documento; solo la tasa de referencia del BCRD es unmedida ponderada.

3- El análisis con Inteligencia Artificial no es 100% fiable; siempre debe examinarse con ojo crítico.
:::